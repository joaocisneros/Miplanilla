...
const inp = 'mt-1 block w-full rounded-md border-gray-300 pr-10 shadow-sm focus:border-indigo-500 focus:ring-indigo-500';
...
<template>
    <section>
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">Usa una contraseña larga y segura para proteger tu cuenta.</p>
        </header>
